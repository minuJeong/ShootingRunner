...
Shader "Toony Colors Pro/OutlineConst/MultipleLights/Bumped Specular Rim"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsSpec nolightmap nodirlightmap approxview 
	...
	Fallback "Toony Colors Pro/OutlineConst/MultipleLights/Bumped Rim"
}
