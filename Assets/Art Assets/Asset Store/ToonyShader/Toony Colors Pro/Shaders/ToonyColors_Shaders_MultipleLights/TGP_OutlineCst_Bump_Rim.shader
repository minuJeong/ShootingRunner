...
Shader "Toony Colors Pro/OutlineConst/MultipleLights/Bumped Rim"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColors nolightmap nodirlightmap approxview 
	...
	Fallback "Toony Colors Pro/OutlineConst/MultipleLights/Basic Rim"
}
